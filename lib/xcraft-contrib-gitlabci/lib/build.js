  ...
  xcraftPortal.connect (null, function () {
    ...
    var args = {
      packageArgs: [
        ...
        'p:data.get.ref=' + self.opts.sha
      ]
    };

    xcraftPortal.events.subscribe ('pacman.make.finished', function () {
    ...
    xcraftPortal.command.send ('pacman.make', args);
  });
};
