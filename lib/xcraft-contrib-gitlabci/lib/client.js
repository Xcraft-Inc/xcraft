...
Client.prototype.updateBuild = function (runner, id, state, trace, cb) {
  var self = this;
...
Client.prototype.registerRunner = function (token, cb) {
  var self = this;
  var opts = {
    body: {
      token: token
  ...
  request.post (opts, function (err, res, body) {
    ...
    if (res.statusCode === 201) {
      ...
      return cb && cb ('bad request, registration failed');
    }
  });
};

Client.prototype.deleteRunner = function (runner, cb) {
  var self = this;
  var opts = {
    body: {
      token: runner.token
  ...
  request.del (opts, function (err, res, body) {
    ...
    if (res.statusCode === 200) {
      ...
      return cb && cb ('bad request, delete runner failed');
    }
  });
};

Client.prototype.getBuild = function (runner, cb) {
  var self = this;
  ...
  request.post (opts, function (err, res, body) {
    ...
    if (res.statusCode === 201) {
      ...
      return cb && cb ('Unable to get builds');
    } else {
