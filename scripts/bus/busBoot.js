...
module.exports.boot = function ()
{
  ...
  {
    notifier.start (zogConfig.busHost, zogConfig.busNotifierPort, module.exports.emit ('ready'));
  };

  commander.start (zogConfig.busHost, zogConfig.busCommanderPort, startNotifier());
