...
Commands.prototype._helpWidth = function () {
...
ShellCraft.prototype.cli = function (callback) {
  ...
  for (var fct in this.commands) {
    if (!this.commands.hasOwnProperty (fct) && !/^_/.test(fct)) {
      program.option (fct, this.commands[fct].help (true));
    }
  }
